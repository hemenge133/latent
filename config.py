...
class TrainingConfig:
    ...
    validate_every_n_steps: int = 50   # More frequent validation
    test_every_n_steps: int = 250      # More frequent testing
    
    # Paths
    simple_transformer_logdir: str = "runs/baseline_transformer_3digit_fast"  # New name for the optimized version
    latent_transformer_logdir: str = "runs/latent_transformer_3digit_fast"    # New name for the optimized version
    checkpoints_dir: str = "checkpoints"
    
    # Names
    simple_transformer_name: str = "simple_transformer_3digit_fast"  # New name for the optimized version
    latent_transformer_name: str = "latent_transformer_3digit_fast"  # New name for the optimized version 
